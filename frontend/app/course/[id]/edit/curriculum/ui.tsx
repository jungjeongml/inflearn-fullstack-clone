...
export default function UI({ initialCourse }: { initialCourse: Course }) {
  ...
  const addSectionMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["course", initialCourse.id] }); //전체 course가 다시 fetch되도록 해주는 부분, 미리 정의를 해두었었음.
  ...
  return (
    <div className="space-y-8 flex flex-col items-center">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                }} //input창에 focus상태에서 해제됐을때 update실행.
      ...
      {/* 섹션 추가 */}
      <Button onClick={handleAddSection} variant="default" size="lg" className='text-md font-bold mx-auto'>
        섹션 추가
      </Button>
